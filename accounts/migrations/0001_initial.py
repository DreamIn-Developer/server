    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background_image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='background_image', to='images.image')),
            ],
            options={
                'ordering': ['-id'],
            },
        ...
        migrations.AddField(
            model_name='user',
            name='profile_image',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profile_image', to='images.image'),
        ),
        migrations.AddField(
            model_name='user',
